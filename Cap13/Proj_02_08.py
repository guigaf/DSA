...
Valor_Venda_Desconto_Nao_Concedido = Valor_Venda_Desconto_15["Valor_Venda"].mean()
Valor_Venda_Desconto_Concedido = Valor_Venda_Desconto_15["Valor_Venda_Com_Desconto"].mean()

print("A Média do Valor de Venda Antes do 15", "%",  "de desconto é: ", (Valor_Venda_Desconto_Nao_Concedido))
print("A Média do Valor de Venda Depois do 15", "%",  "de desconto é: ", (Valor_Venda_Desconto_Concedido))
